        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="<?=!is_allow("M_DATA_SERVER") ? 'hide' : ''?>">
                        <a href="<?=base_url()?>data_server"><i class="fa fa-send"></i><span
                                class="nav-label">Server</span></a>
                    </li>
                    <li class="<?=!is_allow("M_DATA_APLIKASI") ? 'hide' : ''?>">
                        <a href="<?=base_url()?>data_aplikasi"><i class="fa fa-send"></i><span
                                class="nav-label">Aplikasi</span></a>
                    </li>
